// *************************************************
// MMG.Infra.OAPersistence.OAContextManager.cs
// Last Modified: 08/30/2013 1:27 PM
...
{
    public class OAContextManager : IDbContextManager
    {
        private static readonly Lazy<OAContextManager> _instance = new Lazy<OAContextManager>(() => new OAContextManager());
        ...
        {
            get { return "OADefaultDb"; }
        }

        public static OAContextManager Instance
        {
        ...
        private void addConfiguration(string pConnectionStringName, IDbContextConfiguration pDbContextConfig)
        {
            ...
            lock (_syncLock)
            {
                ...
                _dbContextBuilders.Add
                    (pConnectionStringName,
                     new OAContextBuilder<OADbContext>(pConnectionStringName, (OAContextConfiguration) pDbContextConfig));
            }
        }
    }
}